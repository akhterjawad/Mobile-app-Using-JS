...
function renderScreen() {
    ...
    <div class="text-center p-2">
        <img src="${item.img}" class="card-img-width img-fluid" alt="no image">
    </div>
    ...
    <div class="fw-lighter d-flex align-items-center justify-content-between">
        ...
        <div>
            <button type="button" onclick="deleteItem(${i})" class="btn btn-sm btn-outline-success mb-2">Delete</button>
        </div>
    </div>
</div>
`;
